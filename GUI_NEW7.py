...
canvas.place(relx=0.152, rely=0.05, anchor="nw")
...
def resize(input_path): #acts as resize not enlarge
    ...
    '''''''''
    #acts as enlarge if you use this commented out code
    ...
    #cv2.imwrite("/Users/muratbarlas/Desktop/image_set/images/" + os.path.basename(file_path_master).split(".")[0] + ".jpg", resized)
    cv2.imwrite(input_path, resized)
    #select_area(given_file="/Users/muratbarlas/Desktop/image_set/images/" + os.path.basename(file_path_master).split(".")[0] + ".jpg")
...
def add_noise():
    ...
    #new_img = new_img.save("/Users/muratbarlas/Desktop/image_set/images/" + os.path.basename(file_path_master).split(".")[0]+"NOISE.jpg")
    new_img = new_img.save(path_for_augmented_image +"/" + os.path.basename(file_path_master).split(".")[0]+"NOISE.jpg")
    #print(path_for_augmented_image)
    #select_area(given_file="/Users/muratbarlas/Desktop/image_set/images/" + os.path.basename(file_path_master).split(".")[0]+"NOISE.jpg")
    select_area(
...
def get_points():
    ...
    #canvas.place(relx=0.0, rely=0, anchor="nw")
    canvas.pack()
    canvas.img = img  # Keep reference in case this code is put into a function.
...
def select_area(given_file = None):
    ...
    #annotation = Writer(file_path, w,h)
    ...
    def add_selection():
        ...
        if save_directory  == None:
            ...
            if class_type.get() == "car":
                selected_object ="car"
                color = "yellow"
            elif class_type.get() == "person":
                selected_object ="person"
                color = "turquoise1"
            elif class_type.get() == "truck":
                selected_object ="truck"
                color = "orange"
            elif class_type.get() == "bicycle":
                selected_object ="bicycle"
                color = "springgreen"
            elif class_type.get() == "motorcycle":
                selected_object ="motorcycle"
                color = "green"
            elif class_type.get() == "van":
                selected_object ="van"
                color = "purple"
            elif class_type.get() == "bus":
                selected_object ="bus"
                color = "deep pink"
            elif class_type.get() == "scooter":
                selected_object = "scooter"
                color = "blue"
            elif class_type.get() == "moped":
                selected_object ="moped"
                color = "maroon"
    ...
    if (w > 704/2 and h > 480/2): #allign it to left if image is large
        canvas.place(relx=0.15, rely=0.05, anchor="nw")
        w_rect = 3
        font_size =13
...
tk.Radiobutton(window, text="car", font = boldFont, bg="white", variable =class_type,value ="car").place(relx=0.0, rely =0.08, anchor='nw')
tk.Radiobutton(window, text="person", font = boldFont, bg= "white", variable=class_type, value="person").place(relx=0.0, rely =0.13, anchor='nw')
tk.Radiobutton(window, text="truck", font = boldFont, bg= "white", variable=class_type, value="truck").place(relx=0.0, rely =0.18, anchor='nw')
tk.Radiobutton(window, text="bicycle", font = boldFont, bg= "white", variable=class_type, value="bicycle").place(relx=0.0, rely =0.23, anchor='nw')
tk.Radiobutton(window, text="motorcycle", font = boldFont, bg= "white",variable=class_type, value="motorcycle").place(relx=0.0, rely =0.28, anchor='nw')
tk.Radiobutton(window, text="van", font = boldFont, bg= "white", variable=class_type, value="van").place(relx=0.0, rely =0.33, anchor='nw')
tk.Radiobutton(window, text="bus", font = boldFont, bg= "white", variable=class_type, value="bus").place(relx=0.0, rely =0.38, anchor='nw')
tk.Radiobutton(window, text="scooter", font = boldFont, bg= "white",variable=class_type, value="scooter").place(relx=0.0, rely =0.43, anchor='nw')
tk.Radiobutton(window, text="moped", font = boldFont, bg= "white",variable=class_type, value="moped").place(relx=0.0, rely =0.48, anchor='nw')

boldFont2 = tkFont.Font(size = 20, weight = "bold")
car = tk.Label(window, bg = "white", fg = "yellow", text = "•", font=boldFont2).place(relx=0.07, rely=0.08)
person = tk.Label(window, bg = "white", fg = "turquoise1", text = "•", font=boldFont2).place(relx=0.10, rely=0.13)
truck = tk.Label(window, bg = "white", fg = "orange", text = "•", font=boldFont2).place(relx=0.08, rely=0.18)
bicycle = tk.Label(window, bg = "white", fg = "springgreen" , text = "•", font=boldFont2).place(relx=0.10, rely=0.23)
motorcycle = tk.Label(window, bg = "white", fg = "green", text = "•", font=boldFont2).place(relx=0.131, rely=0.28)
van = tk.Label(window, bg = "white", fg = "purple", text = "•", font=boldFont2).place(relx=0.07, rely=0.33)
bus = tk.Label(window, bg = "white", fg = "deep pink", text = "•", font=boldFont2).place(relx=0.07, rely=0.38)
scooter = tk.Label(window, bg = "white", fg = "blue", text = "•", font=boldFont2).place(relx=0.11, rely=0.43)
moped = tk.Label(window, bg = "white", fg = "maroon", text = "•", font=boldFont2).place(relx=0.10, rely=0.48)
